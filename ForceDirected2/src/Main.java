    ...
    public static void calc() {
        ...
        for(int i1 = 0;i1<=maxnode-1;i1++) {
            ...
            while(cnt<level) {
                ...
                if(nxtsz==0)continue;
                int i2 = (int) nodes[nodenum].neighbor.get((int)(Math.random()*nxtsz));
